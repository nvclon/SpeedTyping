...
file = open("./data/bestscore.txt", 'r+')
...
class Game:
    def __init__(self):
        ...
        pygame.mixer.init()
        self.sound = pygame.mixer.Sound("resources/music/impressive.mp3")
    ...
    def show_text(self, screen, text, x, y, size, color):
        ...
        text_font = pygame.font.Font("resources/fonts/Domine-Regular.ttf", size)
    ...
    def get_word(self):
        file_text = open("data/text.txt").read().split('\n')
